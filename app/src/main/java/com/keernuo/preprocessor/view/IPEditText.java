...
public class IPEditText extends LinearLayout {
    ...
    public void setText(String ipAddress) {
        String[] ipArray = ipAddress.split("\\."); //不能直接使用split(".")的方法直接分隔
        mFirstIP.setText(ipArray[0]);
        mSecondIP.setText(ipArray[1]);
        mThirdIP.setText(ipArray[2]);
        mFourthIP.setText(ipArray[3]);
    }
}  
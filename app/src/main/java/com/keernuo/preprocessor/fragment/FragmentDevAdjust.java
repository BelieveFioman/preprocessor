...
import com.keernuo.preprocessor.adapter.DeviceAdjustAdapter;
 ...
 */
public class FragmentDevAdjust extends Fragment {
     ...
     * Adapter
     */
    private DeviceAdjustAdapter adapter;
    /**
     * ListView
     */
    private ListView lsvDevAdjust;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_dev_adjust, null);
        //获取数据源,暂时是模拟的
        getDeviceData();
        ...
        lsvDevAdjust = (ListView) view.findViewById(R.id.lsv_dev_adjust);
        tvPage = (TextView) view.findViewById(R.id.list_page);
        tvPage.setText(1 + "/" + pageTotal);
        //为ListView配置Adapter
        adapter = new DeviceAdjustAdapter(getActivity(), devDatas);
        lsvDevAdjust.setAdapter(adapter);
        //配置监听器
        setListeners();
